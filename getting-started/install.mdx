...
<Steps>
  <Step title="下载安装包">
    访问八爪鱼 RPA 下载中心（https://rpa.bazhuayu.com/download），下载八爪鱼 RPA 安装文件（.exe 格式），获取最新版本程序。
  </Step>
  <Step title="运行安装程序">
...
机器人属于付费功能，详情请参见 [八爪鱼 RPA 定价](https://rpa.bazhuayu.com/plan)。如需安装，访问八爪鱼 RPA 下载中心（https://rpa.bazhuayu.com/download），选择"机器人"下载对应安装包。安装后登录有机器人使用权限的账号，即可在客户端的机器人模块中管理和调度运行。

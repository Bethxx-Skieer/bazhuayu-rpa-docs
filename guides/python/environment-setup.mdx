...
![Python环境搭建 示意图 1](/environment-setup-01.png)

3. 在安装程序界面中，勾选 "Add Python 3.8 to PATH" 选项，以便在命令行中可以直接使用 python 命令。

![Python环境搭建 示意图 2](/environment-setup-02.png)
...
![Python环境搭建 示意图 3](/environment-setup-03.png)

6. 打开命令提示符（按住键盘 Win键 + R键，输入 "cmd" 并回车），输入 "python" 命令，如果成功显示 Python 版本号，则说明安装成功。

安装成功后再进行后续Python库的安装（如有需要用到Python库的话）。

![Python环境搭建 示意图 4](/environment-setup-04.png)

![Python环境搭建 示意图 5](/environment-setup-05.png)
...
![Python环境搭建 示意图 6](/environment-setup-06.png)
...
![Python环境搭建 示意图 7](/environment-setup-07.png)
 
![Python环境搭建 示意图 8](/environment-setup-08.png)

...
### （2） [2.x 版本的设置方法](https://bazhuayu-rpa-docs.mintlify.site/guides/variables/custom-variable-2x)

### （3） [1.x 版本的设置方法](https://bazhuayu-rpa-docs.mintlify.site/guides/variables/custom-variable-1x)

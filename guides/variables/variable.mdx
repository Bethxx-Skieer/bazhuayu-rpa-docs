...
### （2） [2.x 版本的设置方法](https://rpa.bazhuayu.com/helpcenter/docs/sFOgkN7v)
...
| 参数控件类型 | 附图 |
| --- | --- |
| **文本框 ** 用于单行消息输入到文本框中 | ![变量 示意图 8](images/variable-08.png) |
| **多行文本框 ** 用于多行消息输入到文本框中 ** ** | ![变量 示意图 9](images/variable-09.png) |
| **文件选择框 ** 用于选择本地的某个文件 ** ** | ![变量 示意图 10](images/variable-10.png) |
| **文件夹选择框 ** 用于选择本地的某个文件夹 | ![变量 示意图 11](images/variable-11.png) |
| **下拉菜单-单选** 用于设置下拉框进行选择 | ![变量 示意图 12](images/variable-12.png) |
| **日期** 用于日期的选择，避免日期填写不规范 | ![变量 示意图 13](images/variable-13.png) |
| **时间** 用于时间的选择，避免时间填写不规范 ** ** | ![变量 示意图 14](images/variable-14.png) |
| **密码** 用于填写密码，输入时会用黑点覆盖，避免显示具体的密码内容 ** ** | ![变量 示意图 15](images/variable-15.png) |

### （4） 运行参数设置

对于勾选了“设置为应用启动参数”的任务，每次运行时会先出现【运行参数设置】的弹窗。在弹窗内按要求填写参数，然后点击“运行应用”即可。移动鼠标到参数填写框后面的小问号![变量 示意图 16](images/variable-16.png)上，可以查看该参数填写的详细说明。
...
”，勾选后下次点击”运行“时，将会将上次填写的参数内容自动填入

![变量 示意图 17](images/variable-17.png)

另外也可以通过Webhook来修改自定义参数里的值，详细可以参考文档：[Webhook](https://rpahelpcenter.bazhuayu.com/helpcenter/docs/skmvua)

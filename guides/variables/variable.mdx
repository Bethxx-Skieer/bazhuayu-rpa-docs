...
### 2.2 [2.x 版本的设置方法](https://rpa.bazhuayu.com/helpcenter/guides/variables/custom-variable-2x)

### 2.3 [1.x 版本的设置方法](https://rpa.bazhuayu.com/helpcenter/guides/variables/custom-variable-1x)

### 2.4 运行参数设置

对于勾选了“设置为应用启动参数”的任务，每次运行时会先出现【运行参数设置】的弹窗。在弹窗内按要求填写参数，然后点击“运行应用”即可。移动鼠标到参数填写框后面的小问号❔上，可以查看该参数填写的详细说明。

<strong>注意：</strong>可以勾选“记住内容”，勾选后下次点击“运行”时，将会将上次填写的参数内容自动填入。

![变量 示意图 17](images/variable-17.png)

另外也可以通过API接口来修改自定义参数里的值，详细可以参考文档：[API 接口](https://rpa.bazhuayu.com/helpcenter/features/enterprise/api)
...
各种变量类型，请参考：[内置数据类型](https://rpa.bazhuayu.com/helpcenter/guides/variables/variable-type)

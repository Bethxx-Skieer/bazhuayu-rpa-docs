...
元素的捕获方式见：[捕获元素](https://rpa.bazhuayu.com/helpcenter/guides/elements/capture-element)

![元素 示意图 3](images/element-03.png)

元素的编辑见：[编辑元素](https://rpa.bazhuayu.com/helpcenter/guides/elements/edit-element)

## XPath

XPath是整个软件的难点但又是准确获取元素的核心点；相关内容比较多且需系统性的学习，本文就不做阐述，请参考这下方的系列教程进行学习。

XPath图文教程：[XPath图文教程](https://rpa.bazhuayu.com/helpcenter/guides/elements/xpath)

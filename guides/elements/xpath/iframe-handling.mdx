...
description: "有的网页包iframe框架，在八爪鱼中也需进行相应设置，本教程将详细讲解。"
---

有的网页包iframe框架，在八爪鱼中也需进行相应设置，本教程将详细讲解。

<strong>1、什么是iframe框架</strong>

<strong>如何判断网页包含几层 iframe 框架？</strong>

iFrame Finder插件下载安装（官方）
...
<strong>2、网页具有一层iframe框架的采集方法</strong>

...
![运行Excel宏高级参数面板](images/runexcelmacrocommand-02.png)
...
![运行Excel宏使用示例](images/runexcelmacrocommand-03.png)
...
![运行Excel宏效果展示](images/runexcelmacrocommand-04.png)

![运行Excel宏效果展示](images/runexcelmacrocommand-05.png)

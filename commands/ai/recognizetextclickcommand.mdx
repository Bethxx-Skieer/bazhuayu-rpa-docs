...
![文字点选验证码使用示例 - 流程搭建](images/recognizetextclickcommand-02.png)

### 运行结果

![文字点选验证码使用示例 - 运行结果](images/recognizetextclickcommand-03.png)

![文字点选验证码使用示例 - 运行结果](images/recognizetextclickcommand-04.png)

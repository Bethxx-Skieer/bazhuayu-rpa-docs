---
title: "文字点选验证码"
description: "识别验证码中的文字位置，依次返回坐标或直接顺序点击文字完成验证。网页和桌面软件中的验证码都支持。"
---
...
![文字点选验证码使用示例 - 运行结果](images/recognizetextclickcommand-05.png)

![文字点选验证码使用示例 - 运行结果](images/recognizetextclickcommand-06.png)

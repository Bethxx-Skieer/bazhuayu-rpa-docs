...
![AI图片生成使用示例 - 主流程](images/generateimagecommand-03.png)

![AI图片生成使用示例 - 指令参数配置](images/generateimagecommand-04.png)
...
![参考图片 - 兔子](images/generateimagecommand-05.jpg)

![参考图片 - 森林](images/generateimagecommand-06.jpeg)

生成的效果图：

![生成的效果图](images/generateimagecommand-07.jpg)

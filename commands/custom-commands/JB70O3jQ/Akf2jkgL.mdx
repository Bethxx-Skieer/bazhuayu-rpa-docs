...
![image](images/Akf2jkgL-01.png)

### 指令输出
![image](images/Akf2jkgL-02.png)
...
\{       "field_title": "单选111",       "field_type": "FIELD_TYPE_SINGLE_SELECT",       "property_single_select": \{           "options": [               \{"id": "opt_high", "text": "高", "style": 16\},               \{"id": "opt_low", "text": "低", "style": 18\}           ]       \}   \}

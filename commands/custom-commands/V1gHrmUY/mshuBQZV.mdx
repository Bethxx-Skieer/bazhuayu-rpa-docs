...
![image](images/mshuBQZV-02.png)

使用【打开网页】指令打开登录网页，
![image](images/mshuBQZV-03.png)

3、示例流程代码和运行结果，如下图所示：
![image](images/mshuBQZV-04.png)

## 注意事项
### 1、关于登录流程，自动处理滑块验证的功能收费说明。

在登录流程中，偶发遇到滑块验证（如下图），本指令集成滑块验证功能，无需人工处理，指令将自动完成滑块验证（尝试20次都失败则退出登录流程）。
![image](images/mshuBQZV-05.png)

该滑块验证功能，是收费功能，每次验证消耗￥0.02元，请注意账号余额情况（如下图中左下角红圈标注）。
![image](images/mshuBQZV-06.png)

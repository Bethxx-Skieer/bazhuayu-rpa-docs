---
title: "内容-推荐分析-整体概况数据获取"
---

用于 生意参谋-内容-推荐分析-整体概况数据的获取

# 生意参谋-内容-推荐分析-整体概况<strong>-下载明细</strong>
# <strong>一.功能描述</strong>

用于 生意参谋-内容-推荐分析-整体概况数据的获取
![image](images/7XETvlUQ-01.png)
...
<strong>内容类型：根据页面选择</strong>

<strong>内容来源：根据页面选择</strong>
![image](images/7XETvlUQ-02.png)

---
title: "内容-订阅分析-整体概况数据获取"
---

# 生意参谋-内容-订阅分析-整体概况数据<strong>-下载明细</strong>
# <strong>一.功能描述</strong>

用于 生意参谋-内容-订阅分析-整体概况数据的获取
![image](images/CKZkncoA-01.png)

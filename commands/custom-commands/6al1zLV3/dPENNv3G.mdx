---
title: "内容-逛逛分析-单条效果数据获取"
---

# <strong>生意参谋-内容-</strong>逛逛分析<strong>-单条效果数据-下载明细</strong>
# <strong>一.功能描述</strong>

用于 生意参谋-内容-逛逛分析-单条效果数据的获取


![image](images/dPENNv3G-01.png)

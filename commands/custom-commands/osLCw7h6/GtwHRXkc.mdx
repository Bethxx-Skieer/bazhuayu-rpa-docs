---
title: "交易-交易构成-类目构成数据获取"
---

# <strong>生意参谋-交易-交易构成-类目构成数据-下载明细</strong>
# <strong>一.功能描述</strong>

用于 生意参谋-交易-交易构成-类目构成数据的获取。
![image](images/GtwHRXkc-01.png)
...
![image](images/GtwHRXkc-02.png)


## <strong>运行结果：</strong>
![image](images/GtwHRXkc-03.png)

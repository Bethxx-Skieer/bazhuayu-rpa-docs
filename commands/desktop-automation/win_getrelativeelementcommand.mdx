...
<Tabs>
  <Tab title="常规">
    ![获取相关元素(win)指令参数面板](images/win_getrelativeelementcommand-01.png)
  ...
  <Tab title="高级">
    ![获取相关元素(win)指令参数面板](images/win_getrelativeelementcommand-02.png)
...
![获取相关元素使用示例 - 流程搭建](images/win_getrelativeelementcommand-03.png)
...
![获取相关元素使用示例 - 效果展示](images/win_getrelativeelementcommand-04.png)

![获取相关元素(win)使用示例 - 运行结果](images/win_getrelativeelementcommand-05.png)

![获取相关元素(win)使用示例 - 运行结果](images/win_getrelativeelementcommand-06.png)

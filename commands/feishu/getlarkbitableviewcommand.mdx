...
<Tabs>
  <Tab title="常规">
    ...
    ![获取视图指令参数面板](images/getlarkbitableviewcommand-04.png)
...
![获取视图使用示例](images/getlarkbitableviewcommand-01.png)
...
![获取视图效果展示](images/getlarkbitableviewcommand-02.png)

![获取视图效果展示](images/getlarkbitableviewcommand-03.png)

...
<Tabs>
  <Tab title="常规">
    ...
    ![获取飞书访问凭证指令参数面板](images/getlarkaccesstokencommand-03.png)
...
![获取飞书访问凭证使用示例](images/getlarkaccesstokencommand-02.png)
...
![获取飞书访问凭证效果展示](images/getlarkaccesstokencommand-01.png)

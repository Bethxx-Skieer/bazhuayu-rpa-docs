...
![删除记录使用示例 - 流程搭建](images/deletelarkbitablerecordcommand-02.png)

### 运行结果

![删除记录使用示例 - 运行结果](images/deletelarkbitablerecordcommand-03.png)

![删除记录使用示例 - 运行结果](images/deletelarkbitablerecordcommand-04.png)

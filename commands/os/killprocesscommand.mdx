...
<Tabs>
  <Tab title="常规">
    ...
    ![终止进程指令参数面板](images/killprocesscommand-04.png)
...
![终止进程使用示例](images/killprocesscommand-03.png)
...
![终止进程效果展示](images/killprocesscommand-02.png)

![终止进程效果展示](images/killprocesscommand-01.png)

...
![运行DOS命令高级参数面板](images/executedoscommand-05.png)
...
![运行DOS命令使用示例](images/executedoscommand-02.png)

![运行DOS命令使用示例](images/executedoscommand-03.png)
...
![运行DOS命令效果展示](images/executedoscommand-04.png)

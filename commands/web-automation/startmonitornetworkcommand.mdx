...
![开始监听网页请求 - 需求分析](images/web-monitor-start-need-01.png)

### 资源路径URL分析（抓包分析）

① 在浏览器里打开想要抓取数据的网页，按键盘F12键进入到开发者管理后台，然后点击Network（网络）

![开始监听网页请求 - 抓包分析 1](images/web-monitor-start-packet-01.png)

② 按 Ctrl + R 重新加载网页（或者刷新当前网页），筛选资源类型

![开始监听网页请求 - 抓包分析 2-1](images/web-monitor-start-packet-02a.png)

![开始监听网页请求 - 抓包分析 2-2](images/web-monitor-start-packet-02b.png)
...
![开始监听网页请求 - 抓包分析 3-1](images/web-monitor-start-packet-03a.png)

![开始监听网页请求 - 抓包分析 3-2](images/web-monitor-start-packet-03b.png)
...
![开始监听网页请求 - 应用搭建 1](images/web-monitor-start-app-01.png)

![开始监听网页请求 - 应用搭建 2](images/web-monitor-start-app-02.png)
...
![开始监听网页请求 - 效果展示](images/web-monitor-start-result-01.png)
